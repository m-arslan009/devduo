  ...
  return (
    <section className="mx-auto max-w-7xl px-8 py-16">
      ...
      <div>
        ...
        <h1 className="text-left leading-none text-white text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold">
        ...
        <p className="text-left w-115 text-[14px]">Two <span className="text-white">FAST NUCES</span> developers building real, deployed web apps. MERN stack, Django, React — we handle everything from database to live URL so you don't have to coordinate anyone else.</p>
        <div className="text-left mt-7 flex gap-4">
          <button className="bg-yellow-300 hover:bg-yellow-400 cursor-pointer text-black py-2 px-6 rounded font-semibold text-sm">See our work</button>
          <button className="border border-gray-600 hover:border-gray-400 cursor-pointer py-2 px-6 rounded text-sm text-gray-300 hover:text-white">Get in touch</button>
        </div>
        <div className="flex flex-row gap-4 text-sm mt-10 items-center">
      ...
      <div className="flex flex-col gap-6 pt-16 w-140">
        <div className="border border-gray-700/50 rounded-2xl bg-gray-900/30 p-8 flex justify-between items-center">
          ...
          <div className="border-r border-gray-700/30 h-12"></div>
          <div className="text-center flex-1">
            <div className="text-4xl font-bold text-white">2</div>
            <div className="text-xs text-gray-500 mt-2">Developers</div>
          </div>
          <div className="border-r border-gray-700/30 h-12"></div>
          <div className="text-center flex-1">
            <div className="text-4xl font-bold text-white">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="text-left border border-gray-700/50 rounded-lg bg-gray-900/30 p-5">
